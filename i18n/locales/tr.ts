...
export default {
    ...
    vault: {
        ...
        importConfirmDesc: 'Bu işlem CSV veya JSON dosyasından kasa kayıtlarını içe aktarır.\n\n⚠️ Uyarı: Eğer kasanızda aynı veriler zaten mevcutsa bu işlem kopya kayıtlar oluşturabilir.',
        importInfo: 'Desteklenen formatlar: CSV (Google Şifre Yöneticisi, Bitwarden vb.) ve JSON dışa aktarımları.',
    ...
    settings: {
        ...
        editorBehavior: 'Düzenleyici Davranışı',
        autoSaveDebounce: 'Otomatik Kaydetme Gecikmesi',
        undoRedoDebounce: 'Geri Al/İleri Al Gecikmesi',
        ...
        exportFormatJSON: 'JSON (Yapılandırılmış Yedek)',
        ...
        exportJSONInfo: 'JSON dışa aktarma, sırlar ve notlar için yapılandırılmış bir yedek dosyası oluşturur.',
