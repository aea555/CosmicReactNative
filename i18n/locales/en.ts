...
export default {
    ...
    auth: {
        ...
        passwordSpaceWarning: 'No spaces allowed',
        switchAccount: 'Switch Account / Create New',
        unlockVault: 'Unlock Vault',
        enterMasterPassword: 'Please enter your master password to continue',
    ...
    vault: {
        ...
        importConfirmDesc: 'This imports vault entries from a CSV or JSON file.\n\n⚠️ Warning: This action may create duplicate entries if you already have the same data in your vault.',
        importInfo: 'Supported formats: CSV (Google Password Manager, Bitwarden, etc.) and JSON exports.',
        ...
        saveFromAutofill: 'Autofill captured a new password for {{app}}. Do you want to save it?',
    ...
    settings: {
        ...
        autoSaveDebounce: 'Auto-save Debounce',
        undoRedoDebounce: 'Undo/Redo Debounce',
        millisecondsShort: 'ms',
        exportData: 'Export Data',
        exportDataDesc: 'Download a copy of your vault',
        dangerZone: 'Danger Zone',
        exportFormat: 'Select Export Format',
        exportFormatJSON: 'JSON (Structured Backup)',
        ...
        exportJSONInfo: 'JSON export includes both secrets and notes in a structured backup file.',
